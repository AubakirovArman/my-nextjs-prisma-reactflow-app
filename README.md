...
- Опциональная точка входа для логической схемы
- Может использоваться для явного обозначения начала цепочки
- Не имеет входящих соединений
- Если узел Start отсутствует, выполнение начинается с узлов без входящих соединений
